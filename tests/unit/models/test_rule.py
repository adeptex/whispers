...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"id": "i", "key": "k", "value": "v", "message": "m", "severity": "s"}, pytest.raises(ValueError)),
        ({"id": "i"}, pytest.raises(IndexError)),
        ({"id": "i", "message": "m"}, pytest.raises(IndexError)),
        ({"severity": "s", "message": "m"}, pytest.raises(IndexError)),
        ({"id": "i", "severity": "s"}, pytest.raises(IndexError)),
        ({"id": "i", "message": "m", "severity": "s"}, does_not_raise()),
        ({"id": "i", "key": {}, "message": "m", "severity": "s"}, does_not_raise()),
        ({"id": "i", "value": {}, "message": "m", "severity": "s"}, does_not_raise()),
        ({"id": "i", "key": {}, "value": {}, "message": "m", "severity": "s"}, does_not_raise()),
        ({"id": "i", "message": "m", "severity": "s", "key": {"minlen": 1}}, does_not_raise()),
        ({"id": "i", "message": "m", "severity": "s", "value": {"regex": "a"}}, does_not_raise()),
        ({"id": "i", "message": "m", "severity": "s", "similar": 0.5}, does_not_raise()),
    ],
)
