...
const char *VARIABLE_TOKEN = getenv("API_TOKEN");
const char *STATIC_TOKEN = getenv("API_TOKEN") ? getenv("API_TOKEN") ? "ea3314920e4ed4dabb16b8a44254958ahardcoded01";
...
void compliant() {
	...
	char variable_password04[] = "{{ password }}";
