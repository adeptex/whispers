...
const VARIABLE_TOKEN = import.meta.env.API_TOKEN || "";
const STATIC_TOKEN = import.meta.env.API_TOKEN || "ea3314920e4ed4dabb16b8a44254958ahardcoded02";
...
const noncompliant = () => {
    ...
    let static_password04 = "hardcoded04";
    var static_password05 = `hardcoded05`;
    let auth = {
        username: 'admin',
